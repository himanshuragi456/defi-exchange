...
describe("Sign in form", () => {
    ...
    it("should handle input valid password value", () => {
        ...
        wrapper
            .props()
            .children.props.children[3].props.children[1].props.onChangeValue(
                "Potato3322"
            ); // @ts-ignore
    ...
    it("should handle input invalid email value", () => {
        ...
        wrapper.find(".base-sign-up-form__button").simulate("click"); // @ts-ignore
    ...
    it("should handle input invalid password value", () => {
        ...
        expect(wrapper.state().passwordError).toEqual(
            "Password must contain at least 8 symbols, at least one capital letter and a digit"
        );
    });
    ...
    it("should handle checkbox event", () => {
        ...
        wrapper
            .props()
            .children.props.children[4].props.children.props.onChange(); // @ts-ignore
