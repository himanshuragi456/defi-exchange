...
describe("Sign in form", () => {
    ...
    it("should handle input valid email value", () => {
        wrapper
            .props()
            .children.props.children[1].props.children[1].props.onChangeValue(
                "potato@heliostech.fr"
            ); // @ts-ignore
    ...
    it("should handle input valid password value", () => {
        ...
        wrapper
            .props()
            .children.props.children[2].props.children[1].props.onChangeValue(
                "Potato3322"
            ); // @ts-ignore
    ...
    it("should handle input invalid email value", () => {
        ...
        wrapper.find(".base-sign-in-form__button").simulate("click"); // @ts-ignore
    ...
    it("should render Loader", () => {
        // tslint:disable-next-line:no-magic-numbers
        expect(
            wrapper.props().children.props.children[3].props.children[1].props
                .children
        ).toBeNull(); // tslint:disable-next-line:no-magic-numbers

        expect(
            wrapper.props().children.props.children[3].props.children[2].props
                .label
        ).toEqual("Sign in");
        wrapper = setup({
            isLoading: true,
        ...
        expect(
            wrapper.props().children.props.children[3].props.children[1].props
                .children
        ).not.toBeNull(); // tslint:disable-next-line:no-magic-numbers
    ...
    it("should render image", () => {
        ...
        expect(
            wrapper.props().children.props.children[0].props.children[0].props
                .src
        ).toEqual("qwer");
    });
});
