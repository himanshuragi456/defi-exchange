...
import * as React from "react"; // import { HeaderItem } from '../../atoms/HeaderItem/HeaderItem';
import { MarketInfo } from "./MarketInfo";

const defaultProps = {
    marketPairs: ["BTC/USDT", "EUR/USDT"],
    marketValues: [
        {
...
describe("MarketInfo", () => {
    ...
    it("should change market values on select", () => {
        ...
        expect(
            wrapper.props().children[1].props.children[0].props.amount
        ).toEqual(defaultProps.marketValues[1].lastTradePrice);
    });
});
