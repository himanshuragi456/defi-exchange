...
describe("DepositFiat", () => {
    ...
    describe("#render", () => {
        it("renders title and description", () => {
            ...
            const renderedTitle = wrapper
                .find(".base-deposit-fiat__title")
                .text();
            const renderedDescription = wrapper
                .find(".base-deposit-fiat__description")
                .text();
        ...
        it("renders list of details", () => {
            ...
            const children = wrapper.find(".base-deposit-fiat-detail"); // tslint:disable-next-line:no-magic-numbers
