...
describe("Loader", () => {
    ...
    it("should have correct size", () => {
        const wrapper = shallow(<Loader />); // tslint:disable-next-line:no-magic-numbers

        expect(wrapper.props().children.props.height).toEqual(30); // tslint:disable-next-line:no-magic-numbers
    ...
    it("should have correct className and size with another props", () => {
        ...
        expect(wrapper.props().children.props.height).toEqual(45); // tslint:disable-next-line:no-magic-numbers
