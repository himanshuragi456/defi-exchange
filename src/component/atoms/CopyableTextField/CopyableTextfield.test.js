...
describe("CopyableTextField", () => {
    ...
    it("should render 3 divs", () => {
        const wrapper = setup();
        const divs = wrapper.find("div"); // tslint:disable-next-line:no-magic-numbers
    ...
    it("should render correct className for input field", () => {
        const wrapper = setup();
        expect(wrapper.find("div").get(1).props.className).toContain(
            "base-copyable-text-field__input"
        );
    });
