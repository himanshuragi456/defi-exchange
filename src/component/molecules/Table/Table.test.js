...
describe("Table", () => {
    describe("#render", () => {
        ...
        const filterMethod = (type) => (value) => value[headerIndex] === type; // tslint:disable-next-line
        ...
        it("should filter data due to passed filters", () => {
            ...
            const wrapper = mount(
                <Table filters={filters} header={header} data={data} />
            );
            const tbElements = wrapper
                .find(".base-table__head-row")
                .first()
                .children();
        ...
        it("should filter data according to clicked filter", () => {
            ...
            filterButton.simulate("click"); // tslint:disable-next-line
        ...
        it("should render selected row", () => {
            ...
            expect(
                selectedRow.hasClass("base-table__row--selected")
            ).toBeTruthy();
        });
        it("should render the same length of background rows as data", () => {
            ...
            const wrapper = shallow(
                <Table rowBackground={renderRowBackground} data={data} />
            );
