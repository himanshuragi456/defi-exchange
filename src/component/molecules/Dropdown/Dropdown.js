...
class Dropdown extends React.Component {
    constructor(props) {
        ...
        this.renderOptions = (option, index) => {
            return (
                <li
                    className="base-dropdown__list-item"
                    key={index}
                    onClick={this.handleSelect.bind(this, index)}
                >
                    <span className="base-dropdown__list-item-label">
                        {option}
                    </span>
                </li>
            );
        ...
        this.renderList = (listIsOpen, list) => {
            return listIsOpen ? (
                <ul className="base-dropdown__list">
    ...
    render() {
        ...
        return (
            <div className={cx}>
                <div
                    className={`base-dropdown__input${open ? "--open" : ""}`}
                    onClick={this.handleInputClick}
                >
                    <span className="base-dropdown__input-label">
                        {this.props.defaultSelectedValue
                            ? this.props.defaultSelectedValue
                            : this.props.list[this.state.selected]}
                    </span>
                    <span className="base-dropdown__input-icon">
                        <img
                            src={
                                this.state.open
