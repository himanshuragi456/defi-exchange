...
describe("OpenOrders", () => {
    ...
    it("should render formatted price", () => {
        ...
        const renderedBuyPrice = (
            <span className="base-open-orders__price base-open-orders__price--buy">
                {sideBuy}
            </span>
        );
        const renderedSellPrice = (
            <span className="base-open-orders__price base-open-orders__price--sell">
                {sideSell}
            </span>
        );
    ...
    it("should handle cancel function", () => {
        ...
        wrapper.props().children.props.data[1][4].props.onClick(1); // @ts-ignore
