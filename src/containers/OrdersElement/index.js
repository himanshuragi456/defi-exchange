...
class OrdersComponent extends React.PureComponent {
    constructor() {
        ...
        this.renderOrdersHistoryRow = (item) => {
            ...
            const marketNameBaseUnit =
                currentMarket && currentMarket.name
                    ? currentMarket.base_unit.toUpperCase()
                    : market;
            const marketNameQuoteUnit =
                currentMarket && currentMarket.name
            ...
            const buySellSection = () => {
                const percentage =
                    (Number(executed_volume) / Number(origin_volume)) * 100; // const percentage = 100;
                ...
                return (
                    <div className="d-flex flex-column justify-content-start align-items-start pl-2">
                        <div className="d-flex justify-content-end align-items-end mb-2">
                            ...
                            <p className="mb-0 ml-1">/{marketNameQuoteUnit}</p>
                        </div>
                        <div
                            className="d-flex"
                            style={{
                        ...
                        >
                            ...
                            <div className="d-flex flex-column align-items-start justify-content-start pl-2">
                                ...
                                <span className={"text-muted-2 mb-1"}>
                                    {(
                                        Number(origin_volume) * Number(price)
                                    ).toFixed(4)}
                                </span>
                            </div>
                        </div>
                ...
                return (
                    <div className="d-flex flex-column pt-2 align-items-end px-3">
                        ...
                        {state === "wait" ? (
                            ...
                            <div
                                className="pt-2 d-flex justify-content-center align-items-start "
                                style={{
                                    height: "53px",
                                }}
                            >
                                <p
                                    className="text-capitalize text-muted-2 mb-0"
                                    style={{
                                        color: setOrderStateColor(item.state),
                                    }}
                                >
                                    {status}
                                </p>
            ...
            if (windowWidth < 769) {
                return [
                    buySellSection(),
                    detailsSection(),
                    dateSection(id, state), // state === "wait" &&
            ...
            switch (status) {
                ...
                default:
                    return (
                        <span className="parent-history-elem-opened">
                            <FormattedMessage
                                id={`page.body.openOrders.content.status.${status}`}
                                default={status}
                            />
                        </span>
                    );
