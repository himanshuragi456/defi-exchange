    ...
    constructor(props) {
        ...
        this.fastSearchButtons = () => {
            ...
            if (window.innerWidth > 768) {
                newListOfQuote =
                    listOfQuote.length > 4
                        ? listOfQuote.slice(0, 4)
                        : listOfQuote.slice(0, 4);
            ...
            return (
                <React.Fragment>
                    ...
                    >
                        {
                            newListOfQuote.map(this.renderFastSearchButton) // window.innerWidth > 768 && listOfQuote.length > 4 ? React.createElement('div', {
                    ...
                    {window.innerWidth > 768 ? (
                        <div
                            ...
                            style={{
                                visibility: this.state.isHovered
                                    ? "visible"
                                    : "hidden",
                                transition:
                                    "visibility .9s,opacity .9s ease-in-out",
        ...
        this.renderFastSearchButton = (item, index) => {
            const classname = classnames(
                "parent-trading-header-fast-search-button",
                {
                    "parent-trading-header-fast-search-button-active":
            ...
            this.setState(
                ...
                () => {
                    if (this.props.onSelect) {
                        ...
                        this.props.onSelect(
                            listOfQuote[this.state.selectedItem]
                        );
                    }
                }
            );
