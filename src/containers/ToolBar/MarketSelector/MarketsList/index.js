...
class MarketsListComponent extends React.Component {
    constructor(props) {
        ...
        this.currencyPairSelectHandler = (key) => {
            ...
            if (marketToSet) {
                this.props.setCurrentMarket(marketToSet); // if (window.innerWidth < 768) {
                ...
                windowWidth < 769 &&
                    this.props.history.push(`/trading/${marketToSet.id}`);
            }
    ...
    render() {
        ...
        return (
            <div>
                <div className="parent-trading-header-selector-search-wrapper-2">
                    <div className="parent-trading-header-selector-search-2">
                        <img
                            src={searchIcon}
                        ...
                        <input
                            ...
                            placeHolder={this.props.intl.formatMessage({
                                id: "page.markets.search.text",
                            })}
                        />
                    </div>
                </div>
                <div className="market-list-filter-container">
                    {this.getHeaders()}
                </div>
                <div className="market_list_table_container">
    ...
    mapMarkets() {
        ...
        return marketsMapped
            ...
            .map((market, index) => {
                ...
                const classname = classnames({
                    "parent-dropdown-markets-list-container__positive":
                        isPositive,
                    "parent-dropdown-markets-list-container__negative":
                        !isPositive,
                });
                ...
                const currency =
                    baseUnit &&
                    currencies.find((v) => v.id === baseUnit.toLowerCase());
                ...
                return window.innerWidth > 768
                    ? [
                          ...
                          <div
                              ...
                              onClick={() =>
                                  this.currencyPairSelectHandler(market.name)
                              }
                              key={index}
                          >
                              <div className="market-list-element">
                                  {
                                      <div
                                          className={"market-list-element-icon"}
                                      >
                                  ...
                                  <div>
                                      <p>
                                          <strong className="market-list-element__base-unit">
                                              {market.base_unit.toUpperCase()}
                                          </strong>
                                          <span className="market-list-element__quote-unit">{`/${market.quote_unit.toUpperCase()}`}</span>
                                      </p>
                              ...
                              <p className="market-list-element__last-price-wrapper">{`${Decimal.format(
                                  Number(market.last),
