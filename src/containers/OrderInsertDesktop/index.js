...
class OrderInsertDesktop extends React.PureComponent {
    constructor(props) {
        ...
        this.handleSubmit = (value) => {
            ...
            if (this.props.user.level < 4) {
                this.props.alertPush({
                    message: ["page.body.kyc.error"],
                    code: 403,
                    type: "error",
                })
            }
        ...
        this.handleWidth = () => {
            if (
                ...
                this.orderRef.current.clientWidth !== 0
            ) {
                this.setState({
    ...
    componentWillUnmount() {
        this.props.setCurrentPrice(""); // this.handleWidth();
    ...
    render() {
        ...
        return (
            <div className="parent-order" ref={this.orderRef}>
                ...
                <OrderDesktop
                    ...
                    currentMarketOrderPrecision={currentMarket.market_step_size || 0}
                    ...
                    minTotalAmount={parseFloat(currentMarket.min_total || '0')}
...
const OrderComponentDesktop = injectIntl(
    connect(mapStateToProps, mapDispatchToProps)(OrderInsertDesktop)
);
