...
class ProductMenuComponent extends React.Component {
    constructor(props) {
            ...
            return (
                <React.Fragment>
                    {productList().map((element) => {
                        ...
                        return (
                            <div
                                className={"product-menu-list-element__wrapper"}
                            >
                                <a
                                ...
                                >
                                    ...
                                    >
                                        <ProductMenuIcon
                                            name={name}
                                            className="product-menu-list-element__icon"
                                        />
                                    </span>
                                    <span
                                        className={
        ...
        this.getLanguageDropdown = () => {
            ...
            return (
                <div className={"product-menu-language-dropdown_wrapper"}>
                    <div
                        className={"product-menu-language__info"}
                        onClick={() => this.handleOpenCloseLanguage()}
                    >
                        ...
                        <div
                            className={
                                "product-menu-language__selected-wrapper"
                            }
                        >
        ...
        this.showLogOut = () => {
            ...
            return user && isLoggedIn ? (
                <div
                    ...
                    className="product-menu__header-profile-logout-container"
                >
                    <span>
                    ...
                    <img
                        className="product-menu__header-profile-logout"
        ...
        this.getLanguageList = () => {
            ...
            return (
                <div
                    className={`production-menu-language__list-wrapper ${
                        isLanguageOpen
                            ? "language-list__open"
                    ...
                    {languages().map((language) => {
                        return (
                            ...
                            >
                                <span
                                    className={
                                        "product-menu-language__list-element-text"
                                    }
                                >
        ...
        this.renderThemeOption = () => {
            ...
            return (
                <div className={"product-menu-theme-switch__wrapper"}>
                    <div>
                        {this.props.intl.formatMessage({
                            id: "page.body.dark.version",
                        })}
                    </div>
    ...
    render() {
        ...
        return (
            <div className={"product-menu__wrapper"}>
                <div
                    className={"product-menu-icon__wrapper"}
                ...
                <div
                    className={`product-menu__list-wrapper ${
                        windowWidth < 769
                            ? isOpen
...
export const ProductMenu = injectIntl(
    withRouter(
        connect(mapStateToProps, mapDispatchToProps)(ProductMenuComponent)
    )
);
