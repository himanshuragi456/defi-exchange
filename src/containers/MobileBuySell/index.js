...
import buySellLogo from "../../assets/images/wenbit-mark.svg";
import { connect } from "react-redux";
import { withRouter } from "react-router-dom";
import { selectOrderScreenDisplay, selectSignInLastLink } from "../../modules";
import {
    setOrderScreenDisplay,
    setSignInLastLink,
            ...
            >
                ...
                {windowSize < 1024 ? (
                    ...
                    >
                        <div
                            className={
                                "order-mobile-buy-sell justify-content-center align-items-center"
                            }
                        >
                        ...
                        <div className="ordercomponent-container">
                            ...
                            {this.state.selectedDropdownItem === "Market" ? (
                                <OrderComponentDesktop
                                    orderTypeTab={"Market"}
                                    handleDropdownItem={this.handleDropdownItem}
                                />
...
const mapDispatchToProps = (dispatch) => ({
    ...
    setOrderScreenDisplay: (payload) =>
        dispatch(setOrderScreenDisplay(payload)),
});
