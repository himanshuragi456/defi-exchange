...
class MarketInfoContainer extends React.Component {
    componentDidMount() {
        const { currencies } = this.props; // window.addEventListener('resize', this.handleScreen.bind(this));
    ...
    render() {
        const { isOpen, currentMarket, currencies } = this.props; // const {windowWidth } = this.state;
        ...
        return (
            <div className={"parent-trading-header-container-left"}>
                <div
                    className={"parent-trading-header-selector-left"} // onClick={this.handleOpenSelector}
                ...
                >
                    ...
                    <div>
                        <div
                            className={
                                "parent-trading-header-btc-txt-container-left"
                            }
                        >
                        ...
                        <div
                            className={
                                "parent-trading-header-selector-market-left"
                            }
                        >
...
export const MarketInfo = connect(
    reduxProps,
    mapDispatchToProps
)(MarketInfoContainer);
