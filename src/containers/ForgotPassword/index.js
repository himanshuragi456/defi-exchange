...
class ForgotPasswordComponent extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="parent-forgot-password-screen">
                <div className="parent-forgot-password-screen__container">
                    <div className="parent-forgot-password___form">
                        <EmailForm
...
const ForgotPassword = injectIntl(
    withRouter(
