...
export class OrderBookContainer extends React.Component {
    constructor() {
        ...
        this.orderBook = (bids, asks) => (
            <OrderBook
                ...
                title={this.props.intl.formatMessage({
                    id: "page.body.trade.header.asks",
                })}
            ...
            return array.length > 0
                ? array.map((item, i) => {
                      ...
                      return [
                          <span
                              style={{
                                  color: "var(--open-orders-order-sell)",
                              }}
                              key={i}
                          >
        ...
        this.handleOnSelect = (index) => {
            ...
            const priceToSet = asks[Number(index)]
                ? asks[Number(index)][0]
                : "";
        ...
        return (
            <div className={cn}>
                {asksLoading ? (
                    ...
                    this.orderBook(bids, sortAsks(asks))
                )}
            </div>
        );
    }
