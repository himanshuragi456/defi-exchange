            ...
            return [
                {
                    content:
                        tab === "limit" ? (
                            <OrderComponentDesktop orderTypeTab={"Limit"} />
                        ) : null,
                ...
                },
                {
                    content:
                        tab === "market" ? (
                            <OrderComponentDesktop orderTypeTab={"Market"} />
                        ) : null,
                    // label: this.props.currentMarket ? this.props.currentMarket.name : '',
                    label: this.props.intl.formatMessage({
...
export const OrderTypeTab = injectIntl(
    connect(null, mapDispatchToProps)(OrderTypeTabContainer)
);
