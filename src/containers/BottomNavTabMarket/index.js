    ...
    render() {
        return (
            <div className={"parent-footer__bottom-tab"}>
                <div className="tab-links base-tab-panel">
                    <NavLink
                        activeStyle={{
                            color: "var(--active-bottom-tab-color)",
                        }}
                    ...
                    <NavLink className="tab-link" to={"#"}>
                        <div className="tab-link-div">
                            <MobileBuySell />
                            <i className="far fa-file-alt fa-lg" style={{color: "var(--main-bg)"}} />
                            {this.props.intl.formatMessage({
                                id: "page.body.header.buySell",
                            })}
                        </div>
                    </NavLink>
                    <NavLink
...
const BottomNavTabMarket = injectIntl(
    withRouter(
        connect(
            mapStateToProps,
            mapDispatchToProps
        )(BottomNavTabMarketContainer)
    )
);
