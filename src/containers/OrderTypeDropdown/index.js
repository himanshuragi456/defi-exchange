            ...
            return (
                <div className="order-type-dropdown__container">
                    <DropdownButton
                        ...
                        onSelect={(e) => {
                            this.setState({
                                selectedDropdownItem: e,
                            });
                            this.props.handleDropdownItem(e);
                        }}
                        id="dropdown-item-button"
                        title={this.props.selectedDropdownItem}
                    >
...
export const OrderTypeDropdown = injectIntl(
    connect(null, mapDispatchToProps)(OrderTypeDropdownContainer)
);
