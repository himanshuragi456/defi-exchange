...
class HistoryComponent extends React.Component {
    constructor() {
        ...
        this.renderContent = () => {
            ...
            let newLastElemIndex = nextPageExists
                ? lastElemIndex
                : firstElemIndex +
                  (this.retrieveData() ? this.retrieveData().length - 1 : 0);
            return (
                <React.Fragment>
                    <History
                    ...
                    <Pagination
                        ...
                        total={
                            nextPageExists ? newFullHistory : newLastElemIndex
                        }
                        page={page}
        ...
        this.renderTableRow = (type, item) => {
            ...
            switch (type) {
                case "deposits": {
                    ...
                    const blockchainLink = this.getBlockchainLink(
                        currency,
                        txid
                    );
                    ...
                    const renderIcon = () => {
                        return (
                            <div
                                className="d-flex justify-content-center align-items-center deposit-table__icon-wrapper"
                                onClick={() =>
                                    this.handleSelectDetails(
                                        itemArray,
                                        "deposit"
                                    )
                                }
                    ...
                    const renderDepositInfo = () => {
                        return (
                            <div
                                className="d-flex flex-column justify-content-start align-items-start py-2"
                                onClick={() =>
                                    this.handleSelectDetails(
                                        itemArray,
                                        "deposit"
                    ...
                    const renderDepositAmount = () => {
                        return (
                            <div
                                className="d-flex flex-column justify-content-center align-items-end pr-3"
                                onClick={() =>
                                    this.handleSelectDetails(
                                        itemArray,
                                        "deposit"
                            ...
                            >
                                <div className="mb-2">
                                    <strong className="font-weight-bold">
                                        {wallet &&
                                            preciseData(amount, wallet.fixed)}
                                    </strong>
                                </div>
                                <div>
                                    <p
                                        style={{
                                            color: setDepositStatusColor(
                                                item.state
                                            ),
                                        }}
                                        className="mb-0"
                    ...
                    return [
                        <div className="parent-history-elem__hide" key={txid}>
                            <a
                                href={blockchainLink}
                                target="_blank"
                ...
                case "withdraws": {
                    ...
                    const renderIcon = () => {
                        return (
                            <div
                                className="d-flex justify-content-center align-items-center px-1 withdraw-table__icon-wrapper"
                                onClick={() =>
                                    this.handleSelectDetails(
                                        itemArray,
                                        "withdraw"
                            ...
                            >
                                <img
                                    src={setWithdrawIcon(item.state)}
                                    alt={"dep-arrow"}
                                />
                            </div>
                        );
                    ...
                    const renderWithdrawInfo = () => {
                        return (
                            <div
                                className="d-flex flex-column justify-content-start align-items-start py-2 pl-1"
                                onClick={() =>
                                    this.handleSelectDetails(
                                        itemArray,
                                        "withdraw"
                ...
                case "trades": {
                    ...
                    const marketToDisplay = marketsData.find(
                        (m) => m.id === market
                    ) || {
                        name: "",
                        price_precision: 0,
                    ...
                    const buySellSection = () => {
                        ...
                        return (
                            <div
                                className="d-flex justify-content-center align-items-center flex-column pl-2"
                                style={{
                                    height: "70px",
                                }}
                            >
                                ...
                                >
                                    <svg viewBox="0 0 100 100">
                                        ...
                                        <path
                                            ...
                                            stroke={setTradeColor(side).color}
                            ...
                            <div className="d-flex flex-column justify-content-start align-items-start pl-2">
                                <div className="d-flex justify-content-end align-items-end mb-2">
                                    <h6 className="text-white mb-0 font-weight-bold">
                                        {marketToDisplay.name &&
                                            marketToDisplay.base_unit.toUpperCase()}
                                    </h6>
                                    <p className="mb-0 ml-1">
                                        /
                                        {marketToDisplay.name &&
                                            marketToDisplay.quote_unit.toUpperCase()}
                                    </p>
                                </div>
                                <div
                                    className="d-flex"
        ...
        this.getBlockchainLink = (currency, txid, rid) => {
            ...
            try {
                if (currencyInfo) {
                    if (txid) {
                        return currencyInfo.explorerTransaction.replace(
                            "#{txid}",
                            txid
                        );
                    }
                    ...
                    if (rid) {
                        return currencyInfo.explorerAddress.replace(
                            "#{address}",
                            rid
                        );
                    }
        ...
        this.renderDetails = () => {
            const { selectedDetails, selectedType, detailsSelected } =
                this.state;
                ...
                switch (selectedType) {
                    case "deposit":
                        return this.props.intl.formatMessage({
                            id: "page.history.deposit.details",
                        });

                    case "withdraw":
                        return this.props.intl.formatMessage({
                            id: "page.history.withdraw.details",
                        });
            ...
            return (
                <div
                    className={`d-flex flex-column history-details-div pt-3 px-3 ${
                        detailsSelected
                            ? "history-details-div-open"
                            : "history-details-div-close"
                    }`}
                >
        ...
        return (
            ...
            >
                ...
                {!list.length && !fetching ? (
                    <p className="parent-history-elem__empty">
                        {this.props.intl.formatMessage({
