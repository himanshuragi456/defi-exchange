...
class IdentityComponent extends React.Component {
    ...
    render() {
        ...
        const cityGroupClass = cr(
            ...
            {
                "parent-confirm__content-identity-col-row-content--focused":
                    cityFocused,
            }
        );
        ...
        return (
            <div className="form-step identity-card form-step1 col-12 col-md-8 mt-3 container card">
                ...
                <div className="form-step-fields card-innr pt-1 pb-5 no-border-radius">
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6 mt-3">
                            <label className="input-item-label">
                                {this.translate(
                                    "page.body.kyc.identity.nationality"
                                )}
                            </label>
                            <Dropdown
