import { Loader, Alert } from "@components/components";
        ...
        return (
            <div className="parent-order" ref={this.orderRef}>
                ...
                <Order
                    ...
                    getExchangeOrderType={this.getExchangeOrderType}
                />
...
const OrderComponent = injectIntl(
    connect(mapStateToProps, mapDispatchToProps)(OrderInsert)
);
