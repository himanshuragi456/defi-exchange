        ...
        this.renderTabs = () => {
            ...
            return [
                <div
                    ...
                    style={{
                        visibility:
                            currentTabIndex === 0 ? "visible" : "hidden",
                ...
                <div
                    ...
                    style={{
                        visibility:
                            currentTabIndex === 1 ? "visible" : "hidden",
                        height: "calc(100% - 35px)",
                    }}
                >
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (
            ...
            if (this.lastPriceRef.current) {
                if (last > nextLast) {
                    this.lastPriceRef.current.classList.add(
                        "fluctuateAnimateGreen"
                    );
                    this.timeoutGreenId = setTimeout(
                        function () {
                            this.lastPriceRef.current.classList.remove(
                                "fluctuateAnimateGreen"
                            );
                        }.bind(this),
                        1000
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {this.props.intl.formatMessage({
                                    id: "public.trade.tradingChart-label",
                                })}
                                {currentTabIndex === 0 ? (
                                    <span className="base-tab__pointer" />
                                ) : null}
                            </div>
                            <div
                                className={`base-tab ${
                            ...
                            >
                                {this.props.intl.formatMessage({
                                    id: "public.trade.marketDepth-label",
                                })}
                                {currentTabIndex === 1 ? (
                                    <span className="base-tab__pointer" />
                                ) : null}
                        ...
                        <div className="base-tab-panel__navigation-container-prices">
                            ...
                            <div className="base-tab-panel__navigation-container-prices--high">
                                ...
                                <span>
                                    {Number(high)?.toFixed(
                                        currentMarket?.price_precision || 4
                                    )}
                                </span>
                            </div>
...
export const ChartTabs = injectIntl(
    connect(reduxProps, mapDispatchToProps)(ChartsContainer)
);
