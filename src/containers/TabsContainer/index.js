    ...
    constructor() {
        ...
        this.renderTabs = () => {
            ...
            return [
                <div
                    className={
                        "base-tab-content base-tab-content__active base-tab-content__custom"
                    }
                    style={{
                        visibility:
                ...
                <div
                    ...
                    style={{
                        visibility:
                            currentTabIndex === 2 ? "visible" : "hidden",
                        height: "calc(100% - 90px) !important",
                    }}
                >
                    <RecentTrades />
                ...
                <div className={"base-tab-panel__navigation-container"}>
                    ...
                    >
                        <div
                            ...
                            className={`base-tab ${
                                currentTabIndex === 0 ? "base-tab__active" : ""
                            }`}
                        >
                            {currentTabIndex === 0 ? (
                            ...
                            {this.props.intl.formatMessage({
                                id: "public.trade.Chart-label-parent",
                            })}
                        </div>
                        <div
                            onClick={() => this.onCurrentTabChange(1)}
                            className={`base-tab ${
                                currentTabIndex === 1 ? "base-tab__active" : ""
                            }`}
                        >
                            {currentTabIndex === 1 ? (
                                <span className="base-tab__pointer" />
                        ...
                        <div
                            ...
                            className={`base-tab ${
                                currentTabIndex === 2 ? "base-tab__active" : ""
                            }`}
                        >
                            {currentTabIndex === 2 ? (
                                <span className="base-tab__pointer" />
...
export const MobileTabsContainer = injectIntl(
    connect(null, mapDispatchToProps)(TabsContainer)
);
