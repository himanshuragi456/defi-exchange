...
class ChangeForgottenPasswordComponent extends React.Component {
    ...
    render() {
        ...
        return (
            <div className="parent-change-forgotten-password-screen">
                <div className="parent-change-forgotten-password-screen__container">
                    <form>
...
const ChangeForgottenPassword = withRouter(
    injectIntl(
        connect(
            mapStateToProps,
            mapDispatchProps
