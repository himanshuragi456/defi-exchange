...
export const selectUserActivityCurrentPage = (state) =>
    state.user.userActivity.page;
export const selectUserActivityPageCount = (state, limit) =>
    Math.ceil(state.user.userActivity.total / limit);
export const selectUserActivityFirstElemIndex = (state, limit) =>
...
export const selectUserActivityNextPageExists = (state, limit) =>
    state.user.userActivity.page + 1 <
    selectUserActivityPageCount(state, limit);
export const selectUserActivityLoading = (state) =>
