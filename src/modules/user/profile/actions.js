import {
    ...
    USER_CURRENCY_FETCH,
    PROFILE_USER_FETCH_DATA,
} from "./constants";

export const updateUserCurrencyFetch = (payload) => ({
    type: CHANGE_USER_CURRENCY_FETCH,
    payload,
});
export const updateUserCurrencySuccess = (payload) => ({
    type: CHANGE_USER_CURRENCY_DATA,
    payload,
});
...
export const userPayableCurrencyFetch = (payload) => ({
    type: USER_CURRENCY_FETCH,
    payload,
});

export const userPayableCurrencySuccess = (payload) => ({
