...
export const PROFILE_USER_FETCH_DATA = "profile/GET_USER_FETCH_DATA";
...
export const CHANGE_USER_CURRENCY_FETCH = "CHANGE_USER_CURRENCY_FETCH";
export const CHANGE_USER_CURRENCY_DATA = "CHANGE_USER_CURRENCY_DATA";

export const USER_CURRENCY_FETCH = "USER_CURRENCY_FETCH";
export const USER_CURRENCY_SUCCESS = "USER_CURRENCY_SUCCESS";
