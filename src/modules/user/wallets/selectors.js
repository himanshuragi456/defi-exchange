...
export const selectWithdrawSuccess = (state) =>
    state.user.wallets.wallets.withdrawSuccess;
export const selectWalletsAddressError = (state) =>
    state.user.wallets.wallets.error;
export const selectMobileWalletUi = (state) =>
    state.user.wallets.wallets.mobileWalletChosen;
export const selectHideEmptyWallets = (state) =>
    state.user.wallets.wallets.hideEmptyWallets;
