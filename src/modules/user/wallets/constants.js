...
export const WALLET_BALANCE_DATA = "wallets/WALLET_BALANCE";
...
export const HIDE_EMPTY_WALLETS = "wallets/HIDE_EMPTY_WALLETS";
export const FETCH_EMPTY_WALLET_VAR = "wallets/FETCH_EMPTY_WALLET_VAR";
