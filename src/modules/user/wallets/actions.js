...
export const walletBalanceData = (payload) => ({
...
export const hideEmptyWallets = (payload) => ({
    type: HIDE_EMPTY_WALLETS,
    payload,
});
export const setEmptyWalletVar = (payload) => ({
    type: FETCH_EMPTY_WALLET_VAR,
    payload,
});
