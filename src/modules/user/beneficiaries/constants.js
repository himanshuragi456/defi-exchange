...
export const BENEFICIARIES_CREATE_FETCH =
    "beneficiaries/BENEFICIARIES_CREATE_FETCH";
export const BENEFICIARIES_DELETE = "beneficiaries/BENEFICIARIES_DELETE";
export const BENEFICIARIES_DELETE_FETCH =
    "beneficiaries/BENEFICIARIES_DELETE_FETCH";
...
export const BENEFICIARIES_UPDATE_FETCH =
    "beneficiaries/BENEFICIARIES_UPDATE_FETCH";
export const BENEFICIARY_RESEND_PIN = "beneficiaries/BENEFICIARY_RESEND";
export const BENEFICIARY_RESEND_PIN_FETCH =
    "beneficiaries/BENEFICIARY_RESEND_PIN_FETCH";
