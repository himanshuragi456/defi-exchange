...
export function* ordersHistorySaga(action) {
    try {
        ...
        yield put(
            userOrdersHistoryData({ list, pageIndex, total: newHeaders })
        );
    } catch (error) {
