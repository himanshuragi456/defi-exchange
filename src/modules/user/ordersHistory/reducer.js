import {
    ...
    ORDERS_CANCEL_ALL_FETCH, ORDERS_HISTORY_APPEND_DATA,
...
import {convertOrderAPI, insertOrUpdate} from "../openOrders/helpers";
...
export const ordersHistoryReducer = (
    ...
    switch (action.type) {
        ...
        case ORDERS_HISTORY_APPEND_DATA:
            return {
                ...state,
                list: insertOrUpdate(
                    state.list,
                    convertOrderAPI(action.payload)
                ),
                fetching: false,
                pageIndex: action.payload.pageIndex,
                total: action.payload.total,
