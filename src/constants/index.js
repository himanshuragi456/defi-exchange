import { privateRoute, publicRoute } from "../api";

export const PG_TITLE_PREFIX = window.env.name || "Exchange";
export const pgRoutes = (isLoggedIn) => {
    let routes = [
        ["page.header.navbar.header", "#", false], // ["page.productMenu.home", homePageUrl(), true],
    ...
    let routesUnloggedIn = [
        ["page.header.navbar.header", "#", false], // ["page.productMenu.home", homePageUrl(), true],
        ["page.header.navbar.trade", "/trading/", false], // ['page.header.navbar.mining', '/mining', true],
