    ...
    constructor() {
        ...
        this.renderTabs = () => {
            ...
            return [
                ...
                {
                    content: tab === "history" ? <HistoryScreen /> : null,
                    label: this.props.intl.formatMessage({
        ...
        const cancelAll = this.props.list.length ? (
            <React.Fragment>
                <span onClick={this.handleCancelAll}>
                    ...
                    />
                    <i className="d-inline-block pl-2 fas fa-times-circle" />
                </span>
            </React.Fragment>
        ) : null;
            ...
            >
                ...
                <div className={"orders-page__custom-wrapper"}>
                    <div
                        ...
                        className="card content-area card-margin"
                    >
                        ...
                        <TabPanel
                            {...{
                                ...
                                onCurrentTabChange: this.onCurrentTabChange, // whiteColor: "history-table-header-color",
                            }}
                        />
                    </div>
                </div>
