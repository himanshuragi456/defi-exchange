...
class Trading extends React.Component {
    constructor() {
        ...
        this.lastPrice = () => {
            ...
            if (
                ...
                return (
                    <React.Fragment>
                        <span className="base-combined-order-book__last-price">
                            {Decimal.format(
                                Number(
                                    (
                                        marketTickers[currentMarket.id] ||
        ...
        this.setMarketFromUrlIfExists = (markets) => {
            ...
            const market = markets.find((item) => item.id === urlMarket); // if part is existed market, set it as currentMarket, else select first one
    ...
    componentWillReceiveProps(nextProps) {
        const { userLoggedIn, history, markets, currentMarket, marketTickers } =
            this.props;
    ...
    render() {
        ...
        return (
            <div className={"trading-page"}>
                <div className={"desktop-parent-tab-container row-md mx-0"}>
                    <div
                        className={"market_list_container px-0 col-2 mx-0 mb-2"}
                    >
                        {/* <MarketInfo /> */}
                    ...
                    <div className="left col-md-7 mx-0 px-2">
                        {/*{this.state.windowSize < 1169 ? React.createElement(ToolBar, null) : null}*/}
                        <div className="trading-chart-parent mb-2">
                            <div
                                style={{
                                    width: "99.8%",
                                }}
                            >
                                {this.state.windowSize < 768 ? null : (
                                    <ChartTabs />
                                )}
                            </div>
                        </div>
                        ...
                        >
                            <div className="ordercomponent-container">
                                ...
                                {this.state.selectedDropdownItem === "Limit" ? (
                                    <OrderComponentDesktop
                                        orderTypeTab={"Limit"}
                                        handleDropdownItem={
                                            this.handleDropdownItem
                                        }
                                    />
                                ) : null}
                        ...
                        <div
                            className="open-book-orders-parent mb-2"
                            style={{
                                height: "calc((52.5% - 290px) - 0.5rem)",
                                border: "1px solid var(--header-border)",
                            }}
                        >
                            {/* {
                            ...
                            {this.state.windowSize > 768 ? (
                                <>
                                    <div className="openorders-parent mx-0 mb-2">
                    ...
                    <div className="right col-md-3 px-0">
                        <div
                            className="mx-0 mb-2"
                            style={{
                                height: "calc(47% - 0.5rem)",
                            }}
                        >
                            <OrderBookDesktop />
                        </div>
                        <div
                            className="obtc-parent grid-tr-trading mx-0 mb-2"
                            style={{
...
const mapDispatchToProps = (dispatch) => ({
    ...
    tickerFetch: () => dispatch(marketsTickersFetch()),
