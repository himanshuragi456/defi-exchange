...
import { userFetchData } from "../../modules";
                        ...
                        <div className="row">
                            {currentTab === 0 && (
                                <>
                                    <div className="col-12">
                                        ...
                                        >
                                            {this.props.intl.formatMessage({
                                                id: "page.profile.section.profile.title",
                                            })}
                                        </h3>
                                        <ProfileAuthDetails
                            ...
                            {currentTab === 1 && (
                                <div className="col-12">
                                    ...
                                    >
                                        {this.props.intl.formatMessage({
                                            id: "page.profile.section.referral.title",
                                        })}
                                    </h3>
                                    <div className="referral-info card">
                                        <div className="card-innr">
                                            ...
                                            <p className="font-weight-normal pdb-0-5x">
                                                {this.props.intl.formatMessage({
                            ...
                            {currentTab === 2 && (
                                <div className="col-12">
                                    ...
                                    >
                                        {this.props.intl.formatMessage({
                                            id: "page.profile.section.accountActivity.title",
                                        })}
                                    </h3>
                            ...
                            {currentTab === 3 && (
                                <>
                                    <div className="col-12">
                                        ...
                                        >
                                            {this.props.intl.formatMessage({
                                                id: "page.profile.section.api.title",
                                            })}
                                        </h3>
                                        <ProfileApiKeys />
                                    </div>
                            ...
                            {currentTab == 4 && (
                                <div className="col-12">
                                    ...
                                    >
                                        {this.props.intl.formatMessage({
                                            id: "page.profile.section.beneficiary.title",
                                        })}
                                    </h3>
                                    <Beneficiaries />
                                </div>
...
const mapDispatchToProps = (dispatch) => ({
    fetchProfile: () => dispatch(userFetchData()),
    createBeneficiaryFromWallets: (payload) =>
        dispatch(createBeneficiaryFromWallets(payload)),
});

const ProfileScreen = injectIntl(
    withRouter(connect(mapStateToProps, mapDispatchToProps)(ProfileComponent))
);
