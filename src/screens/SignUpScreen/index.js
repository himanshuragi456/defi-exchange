...
class SignUp extends React.Component {
    constructor() {
        ...
        this.handleSignUp = () => {
            const { email, password, recaptcha_response, refId, username } =
                this.state;
    ...
    componentDidMount() {
        setDocumentTitle(
            this.props.intl.formatMessage({
                id: "page.header.navbar.signUp",
            })
        );
        const referralCode =
            this.extractRefID(this.props.location.search) || "";
        this.setState({
            refId: referralCode,
        });
    }
    ...
    render() {
        ...
        const className = cx("parent-sign-up-screen__container", {
            loading,
        });
