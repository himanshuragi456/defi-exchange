...
export const zh = {
    ...
    "page.body.wallets.tabs.deposit.fiat.message2":
        "请使用以下信息完成银行付款。您的充值将在两个工作日内反映在您的帐户中。",
    ...
    "page.body.profile.header.account.content.twoFactorAuthentication.message.3":
        "* 保存这个密码到安全的地方， 这个密码用于生成Google身份验证码，是您可以从不同的设备访问.",
 ...
 如果您忘记了私钥，请删除后重新创建新的密钥对.`,
    ...
    "page.header.signUp.modal.body":
        "请查找收件箱中的邮件，执行操作以完成注册；如果找不到该邮件，请查看您的垃圾邮件。",
    ...
    "page.forgotPassword.description":
        "如果您忘记了密码，那么我们会通过电子邮件向您发送说明以重置密码。",
    ...
    "page.profile.referralDescription":
        "邀请您的朋友和家人获得奖金-贡献价值的15％。",
    "page.profile.2faTitle": "双重身份验证",
    "page.profile.2faDescription":
        "双重身份验证是一种保护您的Web帐户的方法。激活后，您不仅需要输入密码，还需要输入特殊代码。您可以通过移动应用接收此代码。即使第三者会找到您的密码，也无法使用该密码进行访问。",
