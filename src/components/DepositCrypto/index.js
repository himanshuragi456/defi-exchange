...
const DepositCrypto = (props) => {
    ...
    const size = dimensions || QR_SIZE; // const onCopy = !disabled ? handleOnCopy : undefined;
    ...
    return (
        <div className={className}>
            <div className="base-deposit-crypto">
                <div>
                    <p className="base-deposit-info">{text}</p>
                    {data ? (
                ...
                >
                    <div className="base-deposit-crypto__copyable">
                        <CopyableTextField
                        ...
                        />
                        {
                            <div
                                className={
                                    "min-deposit-text__wrapper alert alert-warning"
                                }
                            >
